package com.hikari.rpc.test.util;

import com.hikari.rpc.protocol.JsonUtil;
import com.hikari.rpc.protocol.RpcRequest;
import com.hikari.rpc.protocol.RpcResponse;
import com.hikari.rpc.protocol.SerializationUtil;
import com.hikari.rpc.test.client.Person;
import com.hikari.rpc.test.server.HelloServiceImpl;
